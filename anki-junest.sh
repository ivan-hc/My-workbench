...
DEPENDENCES="python python-pip-system-certs qt6-multimedia qt6-wayland xdg-utils" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
BINSAVED="gio"
SHARESAVED="applications xml mime X11 wayland"
