...
APP=github-store-bin
BIN="github-store" #CHANGE THIS IF THE NAME OF THE BINARY IS DIFFERENT FROM "$APP" (for example, the binary of "obs-studio" is "obs")
...
_post_installation_processes() {
	printf "\n◆ User's processes: \n\n"
	wget -q https://raw.githubusercontent.com/rainxchzed/Github-Store/main/composeApp/src/commonMain/composeResources/drawable/app-icon.png -O - AppDir/GitHub-Store.png
	# Add here your code
}
