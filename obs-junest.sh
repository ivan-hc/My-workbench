...
libSM.so libsodium.so libsoxr.so libva libwayland libxcb libxshmfence qt v4l libSDL $lib_audio_keywords $lib_browser_launcher"
...
_remove_more_bloatwares() {
	...
	share_remove="gcc gir hwdata i18n terminfo vulkan z"
