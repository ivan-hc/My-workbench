...
DEPENDENCES="fpc fpc-src gcc lazarus make" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
libSM libICE libxkbcommon qt libc_nonshared libdl $lib_audio_keywords $lib_browser_launcher"
