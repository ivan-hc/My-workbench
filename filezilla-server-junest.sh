...
DEPENDENCES="dbus libfilezilla nettle sqlite wxwidgets-gtk3 xdg-utils" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
case "$1" in
   '') _JUNEST_CMD -- /usr/bin/filezilla-server-gui "$@";;
   *) _JUNEST_CMD -- /usr/bin/filezilla-server "$@";;
esac
...
REPO="filezilla-server-appimage"
TAG="latest"
