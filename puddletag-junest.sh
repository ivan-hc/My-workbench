...
APP=puddletag-git
BIN="puddletag" #CHANGE THIS IF THE NAME OF THE BINARY IS DIFFERENT FROM "$APP" (for example, the binary of "obs-studio" is "obs")
DEPENDENCES="ca-certificates "
BASICSTUFF="binutils debugedit gzip python"
...
BINSAVED="certificates python" # Enter here keywords to find and save in /usr/bin
